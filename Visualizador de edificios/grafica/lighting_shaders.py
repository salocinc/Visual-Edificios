...
class SimpleGouraudShaderProgram():
    ...
    def set_light_attributes(self,Kd):
        ...
        glUniform3f(glGetUniformLocation(self.shaderProgram, "Kd"), Kd[0], Kd[1], Kd[2])
        glUniform3f(glGetUniformLocation(self.shaderProgram, "Ks"), 1.0, 1.0, 1.0)
        glUniform3f(glGetUniformLocation(self.shaderProgram, "lightPosition"), -3, -3, 3)
